// tive ajuda do caio da minha sala
// consegui terminar provavelmente em 3 horas;
...
//inserir no grafite;
    public insert(lead: Lead): boolean {
        if(this.lead != null){
            console.log("lapiseira possui grafite");
            return false;
        }
    ...
    public writePage(sheet: number): void {         //gasto de ponta por folha
        if(this.tip == null){
            console.log("fail: nao existe grafite no bico");
            return;
        }
